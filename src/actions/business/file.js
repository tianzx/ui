...
export const EDIT_COMMIT_LOG_PENDING = 'EDIT_COMMIT_LOG_PENDING';
export const EDIT_COMMIT_LOG_SUCCESS = 'EDIT_COMMIT_LOG_SUCCESS';
export const EDIT_COMMIT_LOG_ERROR = 'EDIT_COMMIT_LOG_ERROR';
